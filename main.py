...
def init_db_engine():
    ...
    db_uri = f"mysql+pymysql://{os.environ['DB_USER']}:{os.environ['DB_PASS']}@{os.environ['DB_HOST']}/{os.environ['DB_NAME']}?unix_socket=/cloudsql/{os.environ['INSTANCE_CONNECTION_NAME']}"
